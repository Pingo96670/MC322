...
import lab.entities.bots.interfaces.Communicable;
import lab.entities.bots.interfaces.SelfLearner;
...
public class ParrotRobot extends AerialRobot implements Communicable, SelfLearner {
    ...
    public void learnPhrase(String phrase) throws RobotUnavailableException {
        ...
        // Throws src.RobotUnavailableException otherwise
        if (!isOn()) {
    ...
    public String getDescription() {
        return "The aerial.ParrotRobot class is a subclass of AerialRobot capable of storing phrases and repeating them randomly.";
    }
